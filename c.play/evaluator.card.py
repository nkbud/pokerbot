...
class EvaluationCard:
    ...
    @staticmethod
    def cards_from_prime_product(n: int) -> str:
        """
        ...
        """
        # given the nth prime, return the nth kind
        prime2kind = lambda x: EvaluationCard.STR_RANKS[EvaluationCard.PRIMES.index(x)]
